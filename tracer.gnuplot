...
set title "Temps d'exécution des deux algorithmes en fonction du nombre de noeuds"
set yrange [0:400]
set xrange [1:10000]
set xtics font ",10"
set ytics font ",10"
...
plot "NaiveDijkstra.dat" t "Version Naive de Dijkstra"   linecolor rgb'green', \
     "Dijkstra.dat" title "Dijkstra de  GraphStream" linecolor rgb 'blue'
